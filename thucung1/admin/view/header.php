...
<head>
  ...
  <title>TechBoys - Trang quản lý</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://localhost/test/thucung1/index.php">
        ...
        <div class="sidebar-brand-text mx-3">TechBoys</div>
      ...
      <div class="sidebar-heading">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index.php?act=listtintuc">
            <i class="fa-solid fa-newspaper"></i>
            <span>Tin tức</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="index.php?act=lienhe">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow d-sm-none">
              ...
              <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
                <form class="form-inline mr-auto w-100 navbar-search">
                  <div class="input-group">
                    <input type="text" class="form-control bg-light border-0 small" placeholder="Tìm Kiếm.. for..." aria-label="Search" aria-describedby="basic-addon2">
                    <div class="input-group-append">
                      <button class="btn btn-primary" type="button">
                        <i class="fas fa-search fa-sm"></i>
                      </button>
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="index.php?act=dangxuat" data-toggle="modal" data-target="#logoutModal">
